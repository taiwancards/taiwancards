...
export default class extends Controller {
  static targets = ["card", "text", "zhuyin", "pinyin", "meaning", "lines", "abbr", "abbrText", "abbrReading", "link", "empty"]
  ...
  close() {
    this.element.querySelectorAll("[data-station]").forEach((node) => { node.dataset.active = "false" })
