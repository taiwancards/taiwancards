...
export default class extends Controller {
  ...
  answer(direction) {
    ...
    this.answered = true
    const chosen = this.optionTargets.find((o) => o.dataset.direction === direction)
    const correctOption = this.optionTargets.find((o) => o.dataset.correct === "true")
    ...
    if (this.hasFeedbackTarget) {
      this.feedbackTarget.textContent = isCorrect ? "✓" : `✗ ${this.correctValue}`
      this.feedbackTarget.classList.add(isCorrect ? "text-emerald-600" : "text-red-500")
    }
